...
start:function(){this.out.start();this.report={errors:0,valid:!0,reductionObjects:[]}},end:function(){for(var b=this.report||{errors:0,valid:!0},a=0;a<this.report.reductionObjects.length;++a)delete this.report.reductionObjects[a].reduction;this.report=null;this.out.end(b);return b},clear:function(){this.start();this.end()},registerReduction:function(b){this.report.reductionObjects.push(b)}};a.fn.extend({validity:function(b){return this.each(function(){var c=this;if(this.tagName.toLowerCase()=="form"){var h=
null;typeof b=="string"?h=function(){a(b).require()}:a.isFunction(b)&&(h=b);b&&a(this).bind("submit",function(){a.validity.start();h.apply(c);return a.validity.end().valid})}})},require:function(b){return d(this,function(b){return a(b).val()?a(b).val()!=null&&!!a(b).val().length:!1},b||a.validity.messages.require)},match:function(b,c){if(!c)c=a.validity.messages.match,typeof b==="string"&&a.validity.messages[b]&&(c=a.validity.messages[b]);typeof b=="string"&&(b=a.validity.patterns[b]);return d(this,
a.isFunction(b)?function(a){return!a.value.length||b(a.value)}:function(a){if(b.global)b.lastIndex=0;return!a.value.length||b.test(a.value)},c)},range:function(b,c,h){return d(this,b.getTime&&c.getTime?f(function(a){a=new Date(a.value);return a>=new Date(b)&&a<=new Date(c)}):b.substring&&c.substring&&Big?f(function(a){a=new Big(a.value);return a.greaterThanOrEqualTo(new Big(b))&&a.lessThanOrEqualTo(new Big(c))}):f(function(a){a=parseFloat(a.value);return a>=b&&a<=c}),h||i(a.validity.messages.range,
